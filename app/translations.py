...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "callsign": {
        "de": "Rufzeichen/Nickname",
        "en": "Callsign/Nickname",
        "it": "Nominativo/Nickname",
        "sl": "Klicni znak/Vzdevek",
    },
    "callsign_hint": {
        "de": "Rufzeichen oder Nickname (für Zuhörer/SWL)",
        "en": "Callsign or nickname (for listeners/SWL)",
        "it": "Nominativo o nickname (per ascoltatori/SWL)",
        "sl": "Klicni znak ali vzdevek (za poslušalce/SWL)",
    },
    "callsign_placeholder": {
        "de": "z.B. OE8XBB oder Max",
        "en": "e.g. OE8XBB or Max",
        "it": "es. OE8XBB o Max",
        "sl": "npr. OE8XBB ali Max",
    },
    "message": {
        "de": "Nachricht",
        "en": "Message",
    ...
    "runde_datetime": {
        "de": "Datum und Uhrzeit der Runde",
        "en": "Date and time of the round",
        "it": "Data e ora del turno",
        "sl": "Datum in ura runde",
    },
    "runde_datetime_hint": {
        "de": "Wann findet die Runde statt?",
        "en": "When does the round take place?",
        "it": "Quando si svolge il turno?",
        "sl": "Kdaj poteka runda?",
    },
    "runde": {
        "de": "Runde",
        "en": "Round",
